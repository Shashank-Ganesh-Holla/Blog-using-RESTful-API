...
def edit_post(post_id):
    ...
    if edit_form.validate_on_submit():
        try:
            ...
            db.session.commit()
            return redirect(url_for('show_post', index=id_post))
        except Exception as err:
            print(repr(err))

    return render_template("make-post.html", form=edit_form, identity=True)
...
def post_delete(post_id):
    ...
    try:
        post_to_delete = BlogPost.query.get(delete_id)
